#' Chronic Species Sensitivity Data as compiled in 2025
#' 
#' Chronic species sensitivity data from Envirotox (Connors et al. 2019)
#' 
#' @references
...
#' @name envirotox_25_chronic
#' @docType data
#' @keywords datasets
#' @examples
#' 
#' head(envirotox_25_chronic)
#' 
"envirotox_25_chronic"
