#' Acute Species Sensitivity Data as compiled in 2025
#' 
#' Acute species sensitivity data from Envirotox (Connors et al. 2019)
#' 
#' @references
...
#' @name envirotox_25_acute
#' @docType data
#' @keywords datasets
#' @examples
#' 
#' head(envirotox_25_acute)
#' 
"envirotox_25_acute"
