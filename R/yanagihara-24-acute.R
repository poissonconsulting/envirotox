#' Acute Species Sensitivity Data as compiled by Yanagihara et al. (2024)
#' 
#' Acute species sensitivity data from Envirotox (Connors et al. 2019) as worked up by Yanagihara et al. (2024).
...
#' @name yanagihara_24_acute
#' @docType data
#' @keywords datasets
#' @examples
#' 
#' head(yanagihara_24_acute)
#' 
"yanagihara_24_acute"
